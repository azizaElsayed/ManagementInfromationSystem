...
namespace WindowsFormsApplication4
{
    public partial class Form27 : Form
    {
        ...
        private void Form27_Load(object sender, EventArgs e)
        {
            ...
            //
            cmd = new SqlCommand("select studentid,name from student where nationalid='" + nationalid + "' ", cn);
            cn.Open();
            dv = cmd.ExecuteReader();
            dv.Read();
            textBox1.Text = dv[0].ToString();
            textBox2.Text = dv[1].ToString();
            dv.Close();
            cn.Close();
            //
            ...
            //
            //ca = new SqlCommand("select name from student where StudentId=" + c + "", cn);
            //cn.Open();
            //dr = ca.ExecuteReader();
            //dr.Read();
